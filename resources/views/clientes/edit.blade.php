...
<div class="form-header">
    ...
    <div class="subtitle">Modifica los datos del cliente y guarda los cambios</div>
</div>
...
<div class="form-card">
    ...
    <div class="avatar-preview">
        ...
        <div class="avatar-info">
            <div class="nombre-preview" id="nombrePreview">{{ $cliente->nombre }}</div>
            <div class="id-preview">ID #{{ str_pad($cliente->id, 4, '0', STR_PAD_LEFT) }} · Cliente</div>
        </div>
    </div>
