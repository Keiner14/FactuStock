...
@section('content')
    ...
    <h2 style="color:#378ADD; margin-bottom:1rem;">Editar cliente</h2>
    ...
    <div style="background:white;padding:1rem;border-radius:8px;max-width:420px;box-shadow:0 1px 4px rgba(0,0,0,0.08);">
        <form method="POST" action="{{ route('clientes.update', $cliente) }}">
            ...
            <div style="display:flex;align-items:center;margin-bottom:0.6rem;gap:0.75rem;">
                ...
                <div style="flex:1;">
                    <input type="text" name="nombre" value="{{ old('nombre', $cliente->nombre) }}" style="width:100%;height:30px;border:1.5px solid #D5D9E0;border-radius:5px;padding:0 8px;font-size:0.8rem;" required>
            ...
            <div style="display:flex;align-items:center;margin-bottom:0.6rem;gap:0.75rem;">
                ...
                <div style="flex:1;">
                    <input type="text" name="cedula" value="{{ old('cedula', $cliente->cedula) }}" style="width:100%;height:30px;border:1.5px solid #D5D9E0;border-radius:5px;padding:0 8px;font-size:0.8rem;" required>
            ...
            <div style="display:flex;align-items:center;margin-bottom:0.6rem;gap:0.75rem;">
                ...
                <div style="flex:1;">
                    <input type="text" name="celular" value="{{ old('celular', $cliente->celular) }}" style="width:100%;height:30px;border:1.5px solid #D5D9E0;border-radius:5px;padding:0 8px;font-size:0.8rem;" required>
            ...
            <div style="display:flex;align-items:center;margin-bottom:1rem;gap:0.75rem;">
                ...
                <div style="flex:1;">
                    <input type="text" name="direccion" value="{{ old('direccion', $cliente->direccion) }}" style="width:100%;height:30px;border:1.5px solid #D5D9E0;border-radius:5px;padding:0 8px;font-size:0.8rem;" required>
