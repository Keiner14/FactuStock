...
<div class="form-header">
    ...
    <div class="subtitle">Modifica los datos del usuario y ajusta sus permisos de acceso</div>
</div>
        ...
        <div class="seccion-card">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="direccion" value="{{ old('direccion', $usuario->direccion) }}" required>
                </div>
            </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <div class="hint">Déjala vacía si no deseas cambiarla</div>
                </div>
            ...
            <div class="permisos-grid">
                ...
                <label class="permiso-item">
                    <input type="checkbox"
                           ...
                           value="{{ $key }}"
                           class="check-permiso"
                           {{ in_array($key, old('permisos', $permisosUsuario)) ? 'checked' : '' }}>
